...
namespace _VictorDev.Framework
{
    ...
    public class PositionTo2DPoint : MonoBehaviour
    {
        ...
        [Foldout("[設定]"), SerializeField] private EnumAlignmentPivotY alignAxisY = EnumAlignmentPivotY.Top;
        ...
        void Update()
        {
            ...
            if (target3DObject.TryGetComponent(out MeshRenderer meshRenderer))
            {
